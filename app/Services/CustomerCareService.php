...
class CustomerCareService {
    ...
    private function buildHtml(array $ticket): string {
        ...
        return '<!doctype html><html lang="vi"><body style="font-family:Arial,sans-serif;color:#111;line-height:1.6;">'
            ...
            . '<p>Trong lúc chờ, bạn có thể xem <a href="' . htmlspecialchars(App::publicUrl('faqs'), ENT_QUOTES, 'UTF-8') . '">Câu hỏi thường gặp</a> hoặc <a href="' . htmlspecialchars(App::publicUrl('tracking'), ENT_QUOTES, 'UTF-8') . '">tra cứu đơn hàng</a>.</p>'
