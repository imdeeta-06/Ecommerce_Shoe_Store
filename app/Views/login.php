...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-page {
            min-height: 100vh;
            background-image: url('<?= BASE_URL ?>assets/images/zen-login-banner-sharp.png');
        ...
        .back-home:focus-visible {
            ...
            border-color: rgba(228, 197, 158, 0.7);
            color: #ffffff;
            outline: none;
        }
...
<main class="login-page">
    ...
    <div class="login-card">
        <a href="<?= BASE_URL ?>" class="back-home" aria-label="Quay về trang chủ Liên Hoa">
        ...
        <a href="<?= BASE_URL ?>" class="login-brand">
            <img src="<?= BASE_URL ?>assets/images/logo-lotus.jpg" alt="Liên Hoa" class="login-brand-icon-img">
        ...
        <form action="<?= BASE_URL ?>login" method="POST">
            ...
            <div class="form-options">
                <label>
                    <span class="login-session-note">Phiên đăng nhập được bảo vệ trên thiết bị này</span>
                </label>
