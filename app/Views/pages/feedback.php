...
<main class="client-page">
    ...
    <form method="post" action="#" onsubmit="event.preventDefault(); alert('Cảm ơn bạn đã gửi phản hồi!'); this.reset();" style="max-width:720px;margin:0 auto;border:1px solid #ddd;padding:2rem;background:#fff;">
