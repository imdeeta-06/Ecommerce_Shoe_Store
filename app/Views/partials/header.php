            ...
            <div class="mobile-nav-footer">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <div class="mobile-user-card">
                        <img src="<?= !empty($_SESSION['user_avatar']) ? BASE_URL . $_SESSION['user_avatar'] : 'https://ui-avatars.com/api/?name='.urlencode($_SESSION['user_name'] ?? 'User').'&background=2A9D8F&color=fff&size=40' ?>" alt="Avatar" class="mobile-user-avatar">
                        <div>
